...
const AboutMe = () => {
  return (
    <div className="max-w-screen-xl mx-auto bg-saladGreen relative overflow-hidden w-full flex flex-col lg:px-[60px] xl:px-[120px] py-[120px]">
      <div className="grid lg:grid-cols-[460px_auto] xl:grid-cols-[566px_auto] grid-rows-[88px_auto_auto_auto]">
        ...
        <p className="col-start-2 lg:text-[34px] xl:text-[45px] leading-[54px] uppercase pb-8">
        ...
        <p
          className={`col-start-2 ${dmSansRegular.className} lg:text-[34px] xl:text-[45px] uppercase h-[267px]`}
        >
      ...
      {aboutMe.map((content, index) => (
        <div
          key={index}
          className="grid lg:grid-cols-[460px_auto] xl:grid-cols-[566px_auto] pb-[155px]"
        >
          <h3
            className={`${dmSansRegular.className} lg:text-[30px] xl:text-[35px] uppercase`}
          >
            {content.title}
          </h3>
          <ul>
            {content.list.map((list, index) => (
              <li
                className="lg:text-[24px] lg:leading-[35px] xl:text-[30px] xl:leading-[54px] flex flex-col lg:gap-[30px] lg:pb-[30px] xl:gap-[40px] xl:pb-[40px] uppercase"
                key={index}
              >
                {list}
