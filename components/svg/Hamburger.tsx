...
const Hamburger = (props: svgProps) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M17.5401 20.61C18.8987 20.61 20.0001 19.5086 20.0001 18.15C20.0001 16.7914 18.8987 15.69 17.5401 15.69C16.1814 15.69 15.0801 16.7914 15.0801 18.15C15.0801 19.5086 16.1814 20.61 17.5401 20.61Z"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
        strokeLinejoin="round"
